...
{
    class LaserPointerOrange : ModItem
    {
        ...
        {
            Projectile.NewProjectile(position, new Vector2(speedX, speedY), type, damage, knockBack, player.whoAmI, ProjLaserPointer.Orange);
            return false;
        }
